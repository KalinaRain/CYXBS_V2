package com.mredrock.cyxbs.ui.widget.slidingTabs;
...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        context.getTheme().resolveAttribute(R.color.theme_default_primary_dark, outValue, true);
